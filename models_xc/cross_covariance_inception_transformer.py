...
default_cfgs = {
    'xciformer_small': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_small.pth'),
    'xciformer_base': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_base.pth'),
    'xciformer_large': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_large.pth'),
    'xciformer_small_384': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_small_384.pth',
        input_size=(3, 384, 384), crop_pct=1.0),
    'xciformer_base_384': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_base_384.pth',
        input_size=(3, 384, 384), crop_pct=1.0),
    'xciformer_large_384': _cfg(url='https://huggingface.co/honey-be/dl/resolve/main/xciformer/xciformer_large_384.pth',
        input_size=(3, 384, 384), crop_pct=1.0),
}
...
class XCFirstPatchEmbed(nn.Module):
    """ 2D Image to Patch Embedding
    """
...
class XCLowMixer(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., pool_size=2, act_layer=nn.GELU,
        **kwargs, ):
        super().__init__()
    ...
    # Cross-Covariance Attention, from XCiT, instead of the vanilla Multi-head Self-Attention in the original iFormer.
...
class XCiFormerBlock(nn.Module):
    ...
    def forward(self, x, H: int, W: int):
        if self.use_layer_scale:
            ...
            x = x + self.drop_path(self.layer_scale_2 * self.local_mp(self.norm3(x), H, W))
...
class XCInceptionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=None, depths=None,
                ...
                drop_rate=0., attn_drop_rate=0., drop_path_rate=0., embed_layer=XCPatchEmbed, norm_layer=None,
...
def xciformer_small(pretrained=False, **kwargs):
    ...
    model = XCInceptionTransformer(img_size=224,
        depths=depths,
...
def xciformer_small_384(pretrained=False, **kwargs):
    ...
    model = XCInceptionTransformer(img_size=384,
        depths=depths,
        embed_dims=embed_dims,
        num_heads=num_heads,
        attention_heads=attention_heads,
